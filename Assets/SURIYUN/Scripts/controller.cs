...
public class controller : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		/*else if(currentBaseState.fullPathHash == ss_cState)
		{
			cameraObject.SendMessage("setCameraPositionJumpView");
			if(!anim.IsInTransition(0))
			{
		...
		/*else if (currentBaseState.fullPathHash == atkState)
		{
		...
		else if (currentBaseState.fullPathHash == atk2State)
		{
			if(Input.GetKeyDown(KeyCode.Keypad6))
			{
		...
		else if (currentBaseState.fullPathHash == atk3State)
		{
			if(Input.GetKeyDown(KeyCode.Keypad6))
			{
		...
		else if (currentBaseState.fullPathHash == deadState)
		{
